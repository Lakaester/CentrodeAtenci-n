/**
 * RECONSTRUCCIÓN — Quejas y Devoluciones: modelo CASO → N TICKETS.
 *
 * ⚠️ DEPRECADO: este script se mantiene por compatibilidad de invocación.
 * La lógica real de reconstrucción con evidencia vive en
 * scripts/reconstruir-quejas-casos.ts. Este script delega en ella.
 *
 * Uso:
 *   node scripts/reconstruir-quejas-casos.js [YYYY-MM-DD] [YYYY-MM-DD]
