...
import { Settings, ReceiptText, Plus, Pencil, Eye, EyeOff, ChevronUp, ChevronDown } from "lucide-react";
import {
  useEstadosConfig,
    ...
    <div className="flex flex-1 min-h-0 flex-col">
      <div className="shrink-0 border-b border-black-10 px-6 py-4">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary-10 text-primary"><Settings size={18} /></div>
          <div>
            <h1 className="text-base font-semibold text-black-85">Configuración</h1>
            <p className="mt-0.5 text-xs text-black-45">Preferencias del sistema, canales y parámetros operativos.</p>
          </div>
        </div>
      </div>
