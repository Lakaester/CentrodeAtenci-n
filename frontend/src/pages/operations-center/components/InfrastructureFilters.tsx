export function InfrastructureFilters() {
  return (
    <div className="flex flex-wrap items-center gap-2">
      {["País", "Producto", "Ambiente", "Estado", "Región"].map((label) => (
      ...
      <div className="ml-auto">
        <input type="text" placeholder="Buscar servicio..." className="rounded-lg border border-black-10 bg-white px-3 py-1.5 text-xs text-black-85 outline-none placeholder:text-black-25 focus:border-[#2563EB] w-48" />
      </div>
    </div>
  );
}
